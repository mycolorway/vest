...
* 子项目 [vest-pocket](https://github.com/mycolorway/vest-pocket) 提供了一些实用的第三方 module 和自定义组件
...
关于 npm 支持，请参考官方文档：https://developers.weixin.qq.com/miniprogram/dev/devtools/npm.html，vest 只是对“构建 npm”操作做了自动化处理。
